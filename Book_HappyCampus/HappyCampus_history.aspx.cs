...
public partial class Book_HappyCampus_HappyCampus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //그리드뷰가 조건으로 받을 값
        lbl_ID.Text = this.User.Identity.Name.Trim();
...

    {
...

        {
...

            {
                ...
                LiteralControl img = new LiteralControl(string.Format("<img src='/Images/icon_file.gif' alt='{0}' title='{0}' style='margin-left:5px;' />", "다운로드:" + row["downloadCount"] + "회"));
